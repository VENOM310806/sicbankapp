...
if(isset($_GET['status'])){
    if($_GET['status'] == 'failed'){
        echo "<script>alert('Gagal menambahkan data jenis bank. Silakan coba lagi.');</script>";
    }
}
			...
			<main class="app-main">
				...
				<div class="app-content-header">
					<div class="container-fluid">
						<div class="row">
							<div class="col-sm-6">
								<h3 class="mb-0">Input Jenis Bank</h3>
							</div>
							<div class="col-sm-6">
							...
							<div class="col-12">
								<div class="card">
									<div class="card-header">
										<h3 class="card-title">Formulir Jenis Bank</h3>
                                    ...
                                    <form action="proses/proses-prodi.php?aksi=inputprodi" method="POST">
									    <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="kode" class="form-control" id="kode" name="kode" placeholder="Masukkan Kode Bank" required>
                                            </div>
											<div class="mb-3">
												<label for="nama" class="form-label">Nama Bank</label>
												<input type="nama" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Bank" required>
											</div>
                                        </div>
